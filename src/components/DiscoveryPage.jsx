...
import VariableDashboard from './VariableDashboard'
...
export default function DiscoveryPage({ onViewCard }) {
  const { colors, dark } = useTheme()
  const [searchParams] = useSearchParams()
  const tabParam = searchParams.get('tab')
  const initialTab = VALID_TABS.includes(tabParam) ? tabParam : 'screener'
