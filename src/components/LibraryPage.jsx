...
function BookCard({ book, index, dark }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: visible
          ? hovered
            ? 'perspective(800px) rotateY(0deg) translateY(-10px)'
        ...
        overflow: 'hidden',
        boxShadow: hovered
          ? `8px 16px 40px rgba(0,0,0,${dark ? 0.6 : 0.25}), 2px 4px 12px rgba(0,0,0,${dark ? 0.4 : 0.15})`
