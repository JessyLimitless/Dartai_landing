...
const MODES = {
  ...
  premium: {
    title: 'DART 픽 프리미엄 문의',
    desc: '매일 아침 단 하나의 상승 시그널 종목 「DART 픽」 구독을 문의해주세요. 연락처를 남겨주시면 안내드립니다.',
    categories: ['DART 픽 프리미엄 구독', '결제·이용 문의', '기타 문의'],
    placeholder: '구독 방식·결제 등 궁금한 점을 자유롭게 적어주세요.',
  },
  api: {
    title: '공시 데이터 연동 문의',
