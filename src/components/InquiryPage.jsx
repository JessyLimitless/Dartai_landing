...
const MODES = {
  default: {
    ...
    categories: ['자동매매 프로그램 제작', 'AI 솔루션 개발', 'DART Insight 구독', '기타 문의'],
    placeholder: '문의 내용을 자유롭게 작성해주세요.',
  },
  premium: {
    title: '구독 신청 · 문의',
    desc: '오늘의 공시 · 일일 브리핑 · 미국장 브리핑 3종을 월 9,900원에 이용하실 수 있어요. 연락처를 남겨주시면 결제 방법을 안내드립니다.',
    categories: ['구독 신청 (월 9,900원)', '결제·해지 문의', '기타 문의'],
