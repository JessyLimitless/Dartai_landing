        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <span style={{ color: R, fontSize: 14, lineHeight: 1.5, flexShrink: 0 }}>·</span>
      ...
      <div style={{ padding: '0 20px 24px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, fontWeight: 700, color: R, letterSpacing: '0.05em', marginBottom: 4 }}>
              BASIC
            </div>
          ...
          <div style={{ padding: '16px 20px' }}>
            {[
              ...
              <div key={i} style={{
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={R} strokeWidth="2.5" strokeLinecap="round">
