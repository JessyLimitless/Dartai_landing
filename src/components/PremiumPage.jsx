...
const FAQ = [
  {
    q: '무료와 뭐가 다른가요?',
    a: '무료는 일부 요약만 열람됩니다. 프리미엄은 매일 2개 콘텐츠(공시 브리핑·미국장 브리핑) 전체 + 매일 채점 + 즉시 알림을 메일로 받아보실 수 있어요.',
  },
  {
    q: '콘텐츠는 매일 오나요?',
    a: '평일 매일입니다. 공시 브리핑은 장 마감 후, 미국장 브리핑은 아침에 발행되고, 메일로도 함께 보내드립니다.',
  },
  {
    q: '왜 신뢰할 수 있나요?',
    ...
    <div className="page-enter" style={{
      ...
      <div style={{ padding: 'clamp(48px, 8vw, 72px) 28px 40px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 16, color: colors.textMuted, lineHeight: 1.65, margin: '0 auto 40px', maxWidth: 400 }}>
          800건 중 핵심만 골라,<br />공시 브리핑과 미국장 브리핑으로 매일 아침.
        </p>
