      ...
      <div className="today-pad" style={{ paddingTop: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{
              fontSize: 11, color: PREMIUM.accent, fontWeight: 600, marginTop: 6,
              display: 'flex', alignItems: 'center', gap: 5,
            }}>
              <span style={{
                width: 6, height: 6, borderRadius: 3, background: PREMIUM.accent,
                boxShadow: '0 0 6px rgba(220,38,38,0.4)',
                animation: (kstHour >= 9 && kstHour < 16) ? 'pulse 1.4s ease-in-out infinite' : 'none',
              }} />
              장중 시세 반영 (09:00~15:30)
            </div>
          </div>
